...
$(document).ready(function()
{
	$(".add-collection").click(function(e)
	{
		...
		if(btnText.trim() == "Add to my collection")
		{
			...
			$().toastmessage('showSuccessToast', "Hadith added to collection.");
		}
		else
		{
			...
			$().toastmessage('showSuccessToast', "Hadith remove from collection.");
		}
    ...
    $(".editCategory").click(function(e){
    	...
    	$(".modal-topic").html($(e.target).closest(".hadith").find("#hadithtopic").html());
    	$(".modal-narrators").html($(e.target).closest(".hadith").find("#hadithnarrators").html());
